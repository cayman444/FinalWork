...
int main(void) {
    ...
    // Проверка на положительность первого элемента массива M
    if (M[0] > 0) {
        printf("Первый элемент массива M положительный: M[0] = %d\n", M[0]);
        fprintf(file, "Первый элемент массива M положительный: M[0] = %d\n", M[0]);
    } else if (M[0] < 0) {
        printf("Первый элемент массива M отрицательный: M[0] = %d\n", M[0]);
        fprintf(file, "Первый элемент массива M отрицательный: M[0] = %d\n", M[0]);
    } else {
        printf("Первый элемент массива M равен нулю: M[0] = %d\n", M[0]);
        fprintf(file, "Первый элемент массива M равен нулю: M[0] = %d\n", M[0]);
    }
